...
<body>
    <div class="wrapper">
        ...
        <div class="section">
            <h3 class="card-title">Check Out Data Waiting for Validation and Delivery</h3>
            ...
            <?php
                ...
                WHERE
                tb_admin.admin_id=tb_checkout.admin_id AND
                ...
                <tr>
                    ...
                    <?php if($row['validasi'] == 'Waiting') {?>
                        
                    <td>
                        <mark><?php echo $row['validasi'] ?> </mark><br>
                        <a class="text-black" href="proses_valid.php?ck_id=<?php echo $row['ck_id'] ?>" onclick="return confirm('You sure The Proof is Valid ?')">
                        <strong>Valid?</strong>
                        </a><br>
                        <a class="text-black" href="proses_nonvalid.php?ck_id=<?php echo $row['ck_id'] ?>" onclick="return confirm('You sure The Proof is NOT Valid?')">
                        <strong>NO?</strong>
                        </a>

                    </td>
                    <?php } else { ?>
                    <td><mark><?php echo $row['validasi'] ?></mark><br>
                    </td>
                    <?php } ?>
            ...
            <?php } ?>
                ...
                <?php if (mysqli_num_rows($produk) == 0) { ?>
                    <tr>
                        <td colspan="13">Theres no Data</td>
                    </tr>
                <?php } ?>
            </table>
        </div>
