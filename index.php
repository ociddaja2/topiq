    ...
    <header>
        <div class="container">
            ...
            <div class="nav-right"> 
                ...
                <ul>
                <li><a href="login.php"><img src="img/login.png" alt="Login" width="27px"></a></li>
                <li><a href="register.php"><img src="img/register.png" alt="Register" width="23px"></a></li>
            ...
            <div class="box">
                <?php
                    ...
                    if($_GET['kat']==''){
                        ...
                        $produk = mysqli_query($conn, "SELECT * FROM tb_product WHERE category_id = $_GET[kat] AND product_status = 1 ORDER BY product_id DESC LIMIT 4");
